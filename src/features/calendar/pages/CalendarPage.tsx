...
import type { CalendarCell, CalendarDay } from "../types/calendar.types";
...
export default function CalendarPage() {
  ...
  const selectedDay = useMemo(() => {
    ...
    return week.days.find((day: CalendarDay) => day.date === date);
  }, [week, selectedDate]);
      ...
      <div className="lg:hidden">
        ...
        <div className="mb-5 flex items-center gap-3">
          ...
          <label className="relative flex h-11 shrink-0 cursor-pointer items-center rounded-lg border px-3 text-sm font-medium">
            📅
            <span className="ml-2 hidden sm:inline">Elegir fecha</span>
            <input
              type="date"
